...
import { CartCard, AddressText, Order, Price,EditCard, EditCart, EditCartPurchase } from './styles/cart.styles'

import { router } from 'expo-router';
import { BackIcon, BackButton } from './styles/cart.styles';
import { EditIcon } from './styles/detail.card.styles';
